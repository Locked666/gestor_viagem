export function autoComplete(inputSelector, hiddenInputSelector, apiUrl) {
    ...
    input.addEventListener("input", async function () {
      ...
      container.setAttribute("class", "list-group position-absolute zindex-dropdown"); // w-100 
    ...
    input.addEventListener("keydown", function (e) {
      let items = document.querySelectorAll(`#${this.id}-autocomplete-list .list-group-item`);
